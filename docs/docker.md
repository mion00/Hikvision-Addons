...
The image is available to download from [DockerHub](https://hub.docker.com/r/pergolafabio/hikvision-doorbell), the configuration values are read from the environment variables, see an example screenshot from Synology Docker.

![Synology Docker installation](../assets/synology.png)
